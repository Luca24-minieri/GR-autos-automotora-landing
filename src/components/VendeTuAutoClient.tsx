...
interface VendeTuAutoClientProps {
  vehiculos: Vehiculo[];
  marcas: string[];
}

export default function VendeTuAutoClient({ vehiculos, marcas }: VendeTuAutoClientProps) {
  ...
  const estimacion = useMemo(() => {
    ...
    const similares = vehiculos.filter(
  ...
  }, [marca, anoTasacion, kmTasacion, vehiculos]);
